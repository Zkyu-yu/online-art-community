  ...
  <div class="blog_container">
    ...
    <div class="table">
      ...
      <ul v-for="(item, index) of blogInfoList" :key="index">
        ...
        <li>
          <el-icon class="inIcon" @click="editBlogShow(index)"><brush /></el-icon>
          <el-icon class="inIcon" @click="deleteOneBlog(index)"><delete /></el-icon>
        </li>
      </ul>
    </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const tableList = ['标题', '作者', '时间', '内容', '操作']
